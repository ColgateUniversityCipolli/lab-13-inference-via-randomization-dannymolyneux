...
\end{alltt}
\begin{verbatim}
## [1] 0.2880493 0.4502331
\end{verbatim}
\end{kframe}
\end{knitrout}
These confidence intervals are all similar to their corresponding t-test confidence intervals. The bootstrap intervals are actually slightly narrower, which likely means that the resampled sampling distributions are less variable than the assumed t distribution (from the t-test). But all in all, the intervals are quite similar, and still exclude zero, suggesting a difference. 
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Question 3
